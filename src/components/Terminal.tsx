...
export const commands: Command = [
  { cmd: "about", desc: "about TeamZ", tab: 8 },
  { cmd: "clear", desc: "clear the terminal", tab: 8 },
  { cmd: "echo", desc: "print out anything", tab: 9 },
  { cmd: "details",desc: "details about the hackathon", tab: 6 },
  { cmd: "email", desc: "send an email to us", tab: 8 },
  { cmd: "help", desc: "check available commands", tab: 9 },
  { cmd: "history", desc: "view command history", tab: 6 }, 
  { cmd: "hackathon", desc: "click here to register for the hackathon", tab: 5 },
  { cmd: "socials", desc: "check out our social accounts", tab: 6 },
